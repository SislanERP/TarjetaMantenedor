...
namespace WindowsFormsApplication1
{
    ...
    class insusuariobio
    {
        ...
        public string insertagrupoacceso(string idusuario, string idgrupo)
        {
            ...
            try
            {
                String consulta1 = "delete from TB_ACCESSGROUP_USER where nAgentIdn = '" + idusuario + "';";
        ...
        public string actualizaub(string idub, string nombre, string rut, string tarjeta)
        {
            string sard = " bien";
            try
            {
        ...
        public string activaub(string idub)
        {
            string sard = " bien";
            try
            {
                String consulta1 = "update TB_USER set nEndDate = '1924988400' where nUserIdn = '" + idub + "' ;";
                SqlCommand sqd1 = new SqlCommand(consulta1, con1._SqlConnetion);
                con1._SqlConnetion.Open();
                sqd1.ExecuteNonQuery();
                con1._SqlConnetion.Close();
